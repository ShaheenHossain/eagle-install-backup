...
sudo adduser --system --quiet --shell=/bin/bash --home=$OE_HOME --gecos 'EAGLEENTMULTI1401' --group $OE_USER
...
sudo git clone --depth 1 --branch $OE_VERSION https://github.com/ShaheenHossain/eagle14ent_01 $OE_HOME_EXT/
...
if [ $IS_ENTERPRISE = "True" ]; then
    ...
    sudo su root -c "printf 'addons_path=/$OE_MAIN_SERVER/$OE_MAIN_SERV_CONF/eagle/addons,/$OE_MAIN_SERVER/custom/addons\n' >> /etc/${OE_CONFIG}.conf"
fi
