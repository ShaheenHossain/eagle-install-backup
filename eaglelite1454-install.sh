...
sudo adduser --system --quiet --shell=/bin/bash --home=$OE_HOME --gecos 'EAGLELITE1454' --group $OE_USER
...
sudo git clone --depth 1 --branch $OE_VERSION https://github.com/ShaheenHossain/eaglelite14 $OE_HOME_EXT/
