#!/bin/bash
################################################################################
# Script for installing Ealge 1.0 on Ubuntu 16.04, 15.04, 14.04 (could be used for other version too)
# Author: Md. Shaheen Hossain
#-------------------------------------------------------------------------------
# This script will install Eagle on your Ubuntu 14.04 server. It can install multiple Eagle instances
...
echo -e "\n---- Creating the EAGLE1076 PostgreSQL User  ----"
...
if [ $INSTALL_WKHTMLTOPDF = "True" ]; then
  echo -e "\n---- Install wkhtml and place shortcuts on correct place for EAGLE1076 ----"
...
echo -e "\n---- Create EAGLE1076 system user ----"
sudo adduser --system --quiet --shell=/bin/bash --home=$OE_HOME --gecos 'EAGLE1076' --group $OE_USER
