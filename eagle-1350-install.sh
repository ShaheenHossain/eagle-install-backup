...
WKHTMLTOX_X64=https://github.com/wkhtmltopdf/wkhtmltopdf/releases/download/0.12.5/wkhtmltox_0.12.5-1.bionic_i386.deb
...
sudo adduser --system --quiet --shell=/bin/bash --home=$OE_HOME --gecos 'EAGLE1350' --group $OE_USER
...
sudo git clone --depth 1 --branch $OE_VERSION https://github.com/ShaheenHossain/odoo_13ent_03 $OE_HOME_EXT/
