...
sudo -H pip3 install -r https://github.com/ShaheenHossain/odoo_13ent/raw/${OE_VERSION}/requirements.txt
...
sudo git clone --depth 1 --branch $OE_VERSION https://github.com/ShaheenHossain/odoo_13ent $OE_HOME_EXT/
