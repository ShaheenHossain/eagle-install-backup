...
#--------------------------------------------------
# Install Dependencies not install in contabo libpng12-0
#--------------------------------------------------
...
sudo adduser --system --quiet --shell=/bin/bash --home=$OE_HOME --gecos 'EAGLE1567' --group $OE_USER
...
sudo git clone --depth 1 --branch $OE_VERSION https://github.com/ShaheenHossain/zubairsh_witsols_15ent $OE_HOME_EXT/
