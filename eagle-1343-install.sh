...
sudo pip3 install -r https://github.com/ShaheenHossain/eagle_ent_13_03/raw/${OE_VERSION}/requirements.txt
...
sudo git clone --depth 1 --branch $OE_VERSION https://github.com/ShaheenHossain/eagle_ent_13_03 $OE_HOME_EXT/
